...
class CatalogApiTests(TestCase):
    ...
    def test_parent_category_products_endpoint_filters_by_subcategory(self) -> None:
        ...
        self.assertEqual(payload["active_subcategory"]["slug"], "gelato-batch-freezer")
        self.assertEqual(payload["active_subcategory"]["h1"], "Gelato Batch Freezer")
        self.assertEqual(payload["active_subcategory"]["seo_title"], "Gelato Batch Freezer | PRO-TAYLOR")
        self.assertEqual(payload["active_subcategory"]["meta_description"], "Gelato Batch Freezer meta description")
        self.assertEqual(payload["active_subcategory"]["lead_text"], "Gelato Batch Freezer lead text")
    ...
    def test_parent_category_products_endpoint_falls_back_to_parent_operational_content_when_child_has_none(self) -> None:
        ...
        self.assertEqual(payload["active_subcategory"]["slug"], "roll-ice-cream-machine")
        self.assertEqual(payload["active_subcategory"]["h1"], "Roll Ice Cream Machine")
        self.assertEqual(payload["active_subcategory"]["seo_title"], "Roll Ice Cream Machine | PRO-TAYLOR")
        self.assertEqual(payload["operational_fit_title"], "Operational Fit")
        self.assertEqual(payload["buyer_review_focus_title"], "Buyer Review Focus")
        self.assertEqual(payload["sourcing_faq_title"], "Sourcing FAQ")
        self.assertEqual(
    ...
    def test_single_child_parent_products_endpoint_hides_tabs_but_aggregates_child(self) -> None:
        ...
        self.assertIsNone(payload["active_subcategory"])
